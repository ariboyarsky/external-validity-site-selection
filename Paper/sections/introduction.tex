...
and the realized experiment confirms the predicted width. For each
four-country source pool with two hidden countries as competing
candidates, the rule picks the candidate that turns out to give the
narrower interval in all thirty choices.
