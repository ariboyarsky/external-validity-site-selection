...
objective is the coverage (rank) gain, $\mathcal{J}\mapsto
...
width surrogate inherits approximate submodularity in the rank-monotone
...
\citet[Eq.~2.9]{boyarsky2026}, so the endpoint values $v_u,v_\ell$ at a
fixed candidate and target inherit their debiased-cross-fitting inference.
Inference for the selected design is more delicate: the criterion is a
...
identity exact; with an estimated or relaxed identity, the tolerance-set
